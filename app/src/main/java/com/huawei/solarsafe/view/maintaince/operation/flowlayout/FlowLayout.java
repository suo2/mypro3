package com.huawei.solarsafe.view.maintaince.operation.flowlayout;
...
public class FlowLayout extends ViewGroup {
    ...
    private void applyGravityToLines(List<LineDefinition> lines, int realControlLength, int realControlThickness) {
        ...
        for (int i = 0; i < linesCount; i++) {
            ...
            int extraThickness = Math.round(Float.parseFloat(String.valueOf(excessThickness * weight / totalWeight)));
