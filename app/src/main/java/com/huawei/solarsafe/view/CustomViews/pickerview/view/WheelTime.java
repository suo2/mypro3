package com.huawei.solarsafe.view.CustomViews.pickerview.view;

import android.view.View;

import com.huawei.solarsafe.R;
import com.huawei.solarsafe.view.CustomViews.pickerview.adapter.ArrayWheelAdapter;
import com.huawei.solarsafe.view.CustomViews.pickerview.adapter.NumericWheelAdapter;
import com.huawei.solarsafe.view.CustomViews.pickerview.lib.WheelView;
import com.huawei.solarsafe.view.CustomViews.pickerview.listener.OnItemSelectedListener;
import com.huawei.solarsafe.view.CustomViews.pickerview.utils.ChinaDate;
...
public class WheelTime {
    ...
    public WheelTime(View view) {
        ...
        //【安全特性】f:STCAL_STATIC_SIMPLE_DATE_FORMAT_INSTANCE   【修改人】zhaoyufeng
    ...
    private void setSolar(int year, final int month, int day, int h, int m, int s) {
      ...
      /*  final Context context = view.getContext();*/
        ...
        //国际化适配,中文和日文环境格式为"年月日",美式英语环境为"月日年",其他环境格式为"日月年"
        ...
        if (language.equals("zh")||language.equals("ja")){
            ...
            wv_day = (WheelView) view.findViewById(R.id.month);
            wv_year = (WheelView) view.findViewById(R.id.day);
        }else{
            wv_day = (WheelView) view.findViewById(R.id.year);
            wv_month = (WheelView) view.findViewById(R.id.month);
            wv_year = (WheelView) view.findViewById(R.id.day);
        }
...
//                maxItem = endD;
    ...
    private void setDividerWidth() {
        ...
        wv_mins.setDividerWidth(dividerWidth);
    ...
    public void setTextXOffset(int xoffset_year, int xoffset_month, int xoffset_day, int xoffset_hours, int xoffset_mins, int xoffset_seconds){
        ...
        if (language.equals("zh")||language.equals("ja")){
            ...
            wv_month.setTextXOffset(xoffset_day);
            wv_day.setTextXOffset(xoffset_month);
