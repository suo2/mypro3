...
import com.huawei.solarsafe.view.CustomViews.pickerview.utils.PickerViewAnimateUtil;
...
//            mDialog.getWindow().setWindowAnimations(R.style.pickerview_dialogAnim);//取消窗口动画
