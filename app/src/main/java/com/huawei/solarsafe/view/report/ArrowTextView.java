...
public class ArrowTextView extends TextView {
    ...
    private void ini(Context context, AttributeSet attrs) {
        ...
        radius = typedArray.getDimension(R.styleable.ArrowTextView_radiuss, 0);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (arrowWidth == 0) {
            arrowWidth = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PX, 15, getResources().getDisplayMetrics());
        }
        if (arrowHeight == 0) {
