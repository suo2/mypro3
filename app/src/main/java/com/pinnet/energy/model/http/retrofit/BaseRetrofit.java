...
import com.pinnet.energy.utils.NetWorkUtil;
...
public class BaseRetrofit {
    ...
    public Retrofit getRetrofit(String baseUrl) {
        ...
        //缓存
        File cacheFile = new File(EnergyApp.getInstance().getCacheDir(), "cache");
    ...
    private final Interceptor mRewriteCacheControlInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (!NetWorkUtil.isNetConnected(EnergyApp.getInstance())) {//断网时配置缓存策略
...
//                        .cacheControl(CacheControl.FORCE_CACHE)
            ...
            if (NetWorkUtil.isNetConnected(EnergyApp.getInstance())) {//在线缓存
//                KLog.e("在线缓存2分钟");
