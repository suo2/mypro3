...
public class AlertDialog {
	...
	public AlertDialog builder() {
		// 获取Dialog布局
		View view = LayoutInflater.from(context).inflate(R.layout.view_alertdialog_layout, null);
	...
	public AlertDialog setPositiveButton(String text, final boolean isDismiss,final OnClickListener listener) {
		showPosBtn = true;
		if ("".equals(text)) {
			btn_pos.setText(context.getString(R.string.determine));
		} else {
	...
	public AlertDialog setPositiveTextColor(int color){
