...
public class LineInterval220or110KVView extends LinearLayout{
    ...
    public LineInterval220or110KVView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        initView();
    }
    private void initView(){
        LayoutInflater.from(context).inflate(R.layout.line_interval_220or110kv_view_layout,this,true);
        ...
        switch3 = (ImageView) findViewById(R.id.switch_15901);
        tx3 = (TextView) findViewById(R.id.tx_15901);
        switch2 = (ImageView) findViewById(R.id.switch_15903);
        tx2 = (TextView) findViewById(R.id.tx_15903);
        circuitBreaker1 = (ImageView) findViewById(R.id.circuit_breaker_15900);
    ...
    public void setData(List<WiringDataBean> dataList, String volLevelValue, String volLevelSecondValue){
        ...
        if(data.containsKey(3)){  //判断电路图1号位置是否有数据
            WiringDataBean data3 = data.get(3);
            tx3.setText(data3.getDispatchNumber()+"");
            if(data3.getValue() != null && data3.getValue().equals("0")){
                switch3.setImageResource(R.drawable.vertical_switch_on);
            }else if(data3.getValue() != null && data3.getValue().equals("1")){
                switch3.setImageResource(R.drawable.vertical_switch_off);
            }else{
                switch3.setImageResource(R.drawable.vertical_switch_error);
            }
        }else{
            switch3.setImageResource(R.drawable.vertical_switch_error);
            tx3.setText("");
        ...
        if(data.containsKey(6)){
            ...
            }else if(data6.getValue().equals("1")){
        ...
        if(volLevelValue.equals(VolLevel_220KV)){
            arrowImg.setImageResource(R.drawable.arrow_220kv);
            updateAllLineColor(context.getResources().getColor(R.color.kv_220));
        }else{
            arrowImg.setImageResource(R.drawable.arrow_110kv);
