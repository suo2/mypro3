...
import com.huawei.solarsafe.view.CustomViews.pickerview.adapter.WheelAdapter;
import com.huawei.solarsafe.view.CustomViews.pickerview.listener.OnItemSelectedListener;
import com.huawei.solarsafe.view.CustomViews.pickerview.model.IPickerViewData;
...
public class WheelView extends View {
    ...
    public void setDividerWidth(int dividerWidth) {
        if (dividerWidth != 0) {
            ...
            paintIndicator.setStrokeWidth(this.dividerWidth);
        }
    }
