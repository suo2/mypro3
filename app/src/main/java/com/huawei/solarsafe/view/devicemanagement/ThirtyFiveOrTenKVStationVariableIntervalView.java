...
public class ThirtyFiveOrTenKVStationVariableIntervalView extends LinearLayout{
    ...
    private ImageView twoCircleState;
    private TextView tx3;
    public ThirtyFiveOrTenKVStationVariableIntervalView(Context context){
        super(context);
        this.context = context;
        initView();
    }

    public ThirtyFiveOrTenKVStationVariableIntervalView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        initView();
    }
    private void initView(){
        LayoutInflater.from(context).inflate(R.layout.thirty_five_or_ten_kv_station_varible_interval_view_layout,this,true);
        ...
        twoCircleState = (ImageView) findViewById(R.id.two_circle_state);
    ...
    public void setData(List<WiringDataBean> dataList, String volLevelValue, String volLevelSecondValue) {
        ...
        if(volLevelValue.equals(VolLevel_35KV)){
            twoCircleState.setImageResource(R.drawable.two_circle_35kv);
            updateAllLineColor(context.getResources().getColor(R.color.kv_35));
        }else{
            twoCircleState.setImageResource(R.drawable.two_circle_10kv);
