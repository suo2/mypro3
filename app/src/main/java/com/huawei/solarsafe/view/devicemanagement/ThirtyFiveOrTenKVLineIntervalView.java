...
public class ThirtyFiveOrTenKVLineIntervalView extends LinearLayout{
    ...
    public ThirtyFiveOrTenKVLineIntervalView(Context context){
        super(context);
        this.context = context;
        initView();
    }
    public ThirtyFiveOrTenKVLineIntervalView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        initView();
    }
    private void initView(){
        LayoutInflater.from(context).inflate(R.layout.thirty_five_or_ten_kv_line_view_layout,this,true);
    ...
    public void setData(List<WiringDataBean> dataList, String volLevelValue, String volLevelSecondValue) {
        ...
        if(data.containsKey(3)){
            ...
            }else if(data3.getValue().equals("1")){
