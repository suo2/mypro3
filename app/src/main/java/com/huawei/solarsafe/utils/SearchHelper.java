...
public class SearchHelper {
    private int[] pyvalue = new int[]{-20319, -20317, -20304, -20295, -20292, -20283, -20265, -20257, -20242, -20230, -20051, -20036, -20032,
    ...
    private String[] pystr = new String[]{"a", "ai", "an", "ang", "ao", "ba", "bai", "ban", "bang", "bao", "bei", "ben", "beng", "bi", "bian",
    ...
    //首字母
    private StringBuilder shortBuffer;
    ...
    private int getChsAscii(String chs) {
        ...
        try {
            ...
            Log.e(TAG, "getChsAscii: "+e.getMessage() );
        }
        return asc;
    }
     ...
     * 词组解析
     */
    public boolean searchResult(String name, String searchWord) {
        String key, value;
        String shortValue;
        searchWord = searchWord.toUpperCase();
        fullBuffer = new StringBuilder();
        shortBuffer = new StringBuilder();
        for (int i = 0; i < name.length(); i++) {
            key = name.substring(i, i + 1);
            ...
            shortBuffer.append(shortValue);
            fullBuffer.append(value);
        }
        if (shortBuffer.toString().toUpperCase().indexOf(searchWord) != -1) {
            return true;
        } else if (fullBuffer.toString().toUpperCase().indexOf(searchWord) != -1) {
            return true;
