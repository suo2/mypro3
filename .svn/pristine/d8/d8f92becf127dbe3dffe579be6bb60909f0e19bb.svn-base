package com.huawei.solarsafe.view.CustomViews.zxing;
...
//        Rect framingRect = cameraPreview.getFramingRect();
        ...
        if (isBarcode){
            framingRect=new Rect(
                    new Double(30*widthScale).intValue(),
                    new Double(582*heightScale).intValue(),
                    new Double(1050*widthScale).intValue(),
                    new Double(1032*heightScale).intValue());//条形码框
        }else{
            framingRect=new Rect(
                    new Double(165*widthScale).intValue(),
                    new Double(432*heightScale).intValue(),
                    new Double(915*widthScale).intValue(),
                    new Double(1182*heightScale).intValue());//二维码框
        }
